      ...
      try {
        ...
        if (json.type === 'FeatureCollection' && json.features) {
           ...
           for (const feature of json.features) {
              ...
              if (points.length > 1) {
                 if (type === 'LineString') points.push(points[0]); // Force Close
        ...
        if (importedLeads.length > 0) {
           ...
           alert(`Imported! Click any shape -> 'Modify' to fix boundaries.`);
        }
    ...
    <div className="min-h-screen bg-gray-50 font-sans flex flex-col overflow-hidden">
      ...
      <div className="bg-white shadow-md p-4 z-[5000] relative flex flex-col md:flex-row justify-between items-center h-auto md:h-16 gap-4 shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => fileInputRef.current.click()} className="p-2 text-gray-600 hover:bg-gray-100 rounded-lg" title="Import SW Maps"><Upload size={20}/></button>
